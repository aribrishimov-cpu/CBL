...
public class OrdersPanel extends JPanel {
    ...
    private Image bunImg, tomatoImg, lettuceImg,
        cookedMeatImg, choppedTomatoImg, choppedLettuceImg;
    ...
    private void createOrders() {
        ...
        orders.add(new OrderEntry(Arrays.asList("bun", "cooked_meat",
            "chopped_lettuce", "chopped_tomato")));
    ...
    */
    private String ingredientToKey(Ingredient ing) {
        ...
        if (cls.equals("Meat")) {
            return ing.isCooked() ? "cooked_meat" : "meat";
        }
        if (cls.equals("PrepIngredient")) {
            String name = ing.getName().toLowerCase();
            if (name.contains("tomato")) {
                return ing.isChopped() ? "chopped_tomato" : "tomato";
            }
            if (name.contains("lettuce")) {
                return ing.isChopped() ? "chopped_lettuce" : "lettuce";
            }
    ...
    protected void paintComponent(Graphics g0) {
        ...
        for (int i = 0; i < ORDER_COUNT; i++) {
            ...
            for (int j = 0; j < ingredientCount; j++) {
                ...
                g.drawImage(icon, startX + j * (ICON_SIZE + BOX_PADDING),
                    iconY, ICON_SIZE, ICON_SIZE, this);
            }
        }
